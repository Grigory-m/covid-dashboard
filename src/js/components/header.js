          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" data-time="all-time" href="#">All time</a>
                <a class="dropdown-item" data-time="last-day" href="#">Last day</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Cases</a>
              <div class="dropdown-menu">
                <a class="dropdown-item" data-case="Confirmed" href="#">Illness</a>
                <a class="dropdown-item" data-case="Deaths" href="#">Deaths</a>
                <a class="dropdown-item" data-case="Recovered" href="#">Recovered</a>
              </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Values</a>
              <div class="dropdown-menu">
                <a class="dropdown-item" data-population="All" href="#">All cases</a>
                <a class="dropdown-item" data-population="Per100k" href="#">Per 100k population</a>
              </div>
            </li>
          </ul>      
